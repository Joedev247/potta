    ...
    return (
        <Sidebar collapsedWidth='65px' width='180px' transitionDuration={500} collapsed={context?.toggle} toggled={true} breakPoint="md" className=' relative bg-blue-500  h-[100vh] z-30  side '>
            <Menu className='relative h-[76vh]' closeOnClick>
                ...
                <MenuItem active={str[1] == 'dashboard' ? true : false} className='mt-8  font-thin' href='/dashboard' icon={<Icon icon="Pie-Chart-2" size={23} color={str[1] == "analytics" || str[1] == undefined || str[1] == "" ? "white" : "black"} />} > <h3 className='text-lg mt-[2px]'>Overview</h3> </MenuItem>
