...
const Policy: React.FC<PolicyProps> = ({ voucherType, onValueTypeChange }) => {
  const { register, watch, setValue, unregister, getValues, formState: { errors } } = useFormContext();
          ...
          <div className="mb-6 p-3 bg-red-50 border border-red-200 rounded-md">
            ...
            <ul className="list-disc pl-5 text-red-500 text-sm">
              {validationErrors.map((error, index) => (
                <li key={index} className="policy-error">{error}</li>
              ))}
            </ul>
          </div>
        )}
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className={`border ${!discountAmount ? 'border-red-300' : 'border-gray-300'} px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500`}
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className={`border ${!discountPercent ? 'border-red-300' : 'border-gray-300'} w-full px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500`}
          ...
          <div className="mb-6 w-1/2">
            {valueType === 'fixed' ? (
              <div>
                <div className="mb-4">
                  <label className="block text-sm font-medium text-gray-700 mb-1">
                    Fixed Cashback Percentage <span className="text-red-500">*</span>
                  </label>
                  <div className="flex items-center">
                    <input
                      type="number"
                      {...register('cashbackAmount')}
                      className={`border ${!cashbackAmount ? 'border-red-300' : 'border-gray-300'} px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500`}
                      placeholder="Enter amount"
                    />
                    <span className="ml-2 text-gray-500">%</span>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className={`border ${!cashbackPercent ? 'border-red-300' : 'border-gray-300'} px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500`}
                      min={0}
                      max={100}
                      placeholder="100"
                    />
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center">
                <input
                  type="number"
                  {...register('balance')}
                  className={`border ${!balance ? 'border-red-300' : 'border-gray-300'} px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500`}
                  placeholder="Enter amount"
                />
                <span className="ml-2 text-gray-500">XAF</span>
              </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className={`border ${!loyaltyPoints ? 'border-red-300' : 'border-gray-300'} px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500`}
                      placeholder="10"
                    />
                  </div>
                  {!loyaltyPoints && (
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className={`border ${!loyaltyAmount ? 'border-red-300' : 'border-gray-300'} px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500`}
                      placeholder="1000"
                    />
                    <span className="ml-2 text-gray-500">XAF</span>
                  </div>
                ...
                <div>
                  ...
                  <div className="flex items-center">
                    <input
                      ...
                      className={`border ${!loyaltyPointsValue ? 'border-red-300' : 'border-gray-300'} px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500`}
                      placeholder="1"
                    />
                  </div>
                  {!loyaltyPointsValue && (
