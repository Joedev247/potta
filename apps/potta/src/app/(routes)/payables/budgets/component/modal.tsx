                    ...
                    <div className="flex flex-col mt-6 px-8">
                        ...
                        <div className="w-full mb-3">
                            ...
                            <div className="flex w-full  rounded-md divide-x">
                                ...
                                <div className="mt-2">
                                    <Select options={[{ value: "XAF", label: "XAF" }]} selectedValue={"XAF"} onChange={() => { }} bg={"border"} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="w-full mb-3">
                            ...
                            <Select options={[{ value: "One time", label: "One time" }]} selectedValue={"One time"} onChange={() => { }} bg={"border"} />
                        </div>
                    </div>
