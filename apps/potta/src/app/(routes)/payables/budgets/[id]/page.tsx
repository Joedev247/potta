...
import DetailMenu from "@/pages/dashboard/menu/detailMenu";
import SideMenu from "@/pages/dashboard/menu/sideMenu";
import BudgetDetailTable from "./table";
                    ...
                    <div className="flex flex-col md:flex-row justify-between gap-6">
                        <div className="flex flex-col border rounded-lg py-4 px-4 cursor-pointer w-full md:w-2/4">
                            <div className="flex justify-between px-3">
                                <div className="flex flex-col gap-2">
                                    <h1 className="text-lg font-semibold">Back to school budget allocation</h1>
                                    <p className="text-xs">Budget goal: <span className="font-semibold"> XAF 1,000,000</span></p>
                                </div>
                                <div className="flex relative">
                                    ...
                                    <div className="flex w-8 h-8 rounded-full border border-white bg-gray-200 absolute items-center justify-evenly text-sm font-semibold right-0">+2</div>
                                </div>
                            </div>
                        ...
                        <div className="flex gap-6 justify-between w-full md:w-2/4">
                            ...
                            <div className="flex border rounded-lg flex-col w-full h-full py-2.5 px-6">
                                ...
                                <div className="flex">
                                    <span className="rounded-full px-4 items-center bg-gray-300">+3 More</span>
                                </div>
                            </div>
                        </div>
                    </div>
