...
const SliderAccount: React.FC<SliderAccountProps> = ({
  ...
  // Handle form submission - simplified to just send parent ID
  const handleSubmit = async () => {
    try {
      ...
      // Simplified payload - let backend handle code generation and hierarchy
      const accountData = {
        name: accountName,
        type: accountType,
        initialBalance: initialBalance,
        parentId: parentAccount || null, // Just send the parent ID
      };
        ...
        <div className="mb-4">
          ...
          <div className="mb-4">
            <SearchableSelect
              ...
              required
              disabled={account !== null} // Disabled when creating child (inherits from parent)
            />
          ...
          {account && (
            <div className="mb-4 p-3 bg-blue-50 rounded-md border border-blue-200">
              ...
              <p className="text-xs text-gray-600 mt-2">
                Account code will be automatically generated by the system
              </p>
            </div>
          )}
          ...
          {/* Info about backend processing */}
          <div className="mb-4 p-3 bg-gray-50 rounded-md">
            <p className="text-xs text-gray-600">
              <strong>Note:</strong> The account code and hierarchy path will be
              automatically generated by the system based on the selected parent
