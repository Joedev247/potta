'use client';
import useGetOneCustomer from '@potta/app/(routes)/pos/customers/hooks/useGetOneCustomer';
      ...
      <div className="max-w-[48rem] bg-white space-y-8 min-w-[45rem] w-full mb-10">
        <div className="h-36 w-full flex items-center justify-between px-8 bg-yellow-800">
          ...
          <div className="text-right text-white">
            ...
            <p><strong>Currency:</strong> {contextData.currency || 'USD'}</p>
          </div>
        </div>
              ...
              <div className="space-y-2 text-sm text-gray-600 flex-col">
                {customerLoading ? (
                  ...
                  <>
                    ...
                    <p>{billingAddress || customerDetails.address?.address || 'No address'}</p>
              ...
              {tableData.map((item: TableItem, index: number) => {
                ...
                return (
                  <tr key={item.id || index}>
                    ...
                    <td className="border-b px-4 py-2">{currencySymbol}{itemTax.toFixed(2)}</td>
                    <td className="border-b px-4 py-2">
            ...
            <div className="w-[50%]">
              ...
              <div className="pl-4">
                <p>
                  ...
                  {contextData.payment_method?.[0]?.replace(/([A-Z])/g, ' $1').toUpperCase() || 'Not selected'}
                </p>
