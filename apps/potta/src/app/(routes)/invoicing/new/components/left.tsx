...
const Left = () => {
  ...
  const validateForm = () => {
    ...
    if (tableData.length === 0) newErrors.lineItems = "At least one item is required";
  ...
  return (
    <div className="max-w-5xl min-w-5xl px-2 overflow-y-auto">
      ...
      <div className="w-full grid grid-cols-4 gap-4">
        ...
        <div className={`${errors.issueDate ? 'error-field' : ''}`}>
          ...
          <input
            ...
            className={`w-full py-2.5 px-4 border ${errors.issueDate ? 'border-red-500' : 'border-gray-200'} rounded-[2px] outline-none mt-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500`}
          />
          {errors.issueDate && (
        ...
        <div className={`${errors.dueDate ? 'error-field' : ''}`}>
          ...
          <input
            ...
            className={`w-full py-2.5 px-4 border ${errors.dueDate ? 'border-red-500' : 'border-gray-200'} rounded-[2px] outline-none mt-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500`}
          />
          {errors.dueDate && (
      ...
      <div className="mt-3 w-full flex flex-col">
        <div className={`w-[50%] flex items-center space-x-3 ${errors.customerName ? 'error-field' : ''}`}>
        ...
        <div className="flex space-x-4 mt-4">
          <div className="w-full">
            <Input
              ...
              onchange={(e: any) => handleInputChange('billing', e.target.value)}
            />
          </div>
          <div className="w-full">
            <Input
              ...
              onchange={(e: any) => handleInputChange('shipping', e.target.value)}
            />
          </div>
        </div>
      </div>
      ...
      <div className={`mt-2 ${errors.paymentMethod ? 'error-field' : ''}`}>
        <div className="grid grid-cols-2 py-4 gap-4">
          ...
          {errors.paymentMethod && (
            <p className="text-red-500 text-sm col-span-2">{errors.paymentMethod}</p>
          )}
