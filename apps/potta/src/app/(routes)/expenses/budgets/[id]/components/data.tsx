...
const SingleBudget = () => {
    return (
        <div className="flex mb-5 flex-col md:flex-row justify-between gap-6">
            <div className="flex flex-col border  py-4 px-4 cursor-pointer w-full md:w-2/4">
                <div className="flex justify-between px-3">
                    <div className="flex flex-col gap-2">
                        <h1 className="text-lg font-medium">Back to school budget allocation</h1>
                        <p className="text-xs">Budget goal: <span className="font-medium"> XAF 1,000,000</span></p>
                    </div>
                    <div className="flex relative">
                        ...
                        <div className="flex w-8 h-8 rounded-full border border-white bg-gray-200 absolute items-center justify-evenly text-sm font-medium right-0">+2</div>
                    </div>
                </div>
                ...
                <div className="flex justify-between px-3 mt-5">
                    <div className="flex gap-3 w-1/3">
                        <div className="flex w-3 h-3 mt-1.5 bg-orange-500 rounded-full">
            ...
            <div className="flex gap-6 justify-between w-full md:w-2/4">
                <div className="flex border  flex-col w-full h-full py-2.5 px-6">
                    ...
                    <div className="flex grow justify-center items-center">
                        <h1 className="font-thin text-5xl">9</h1>
                    </div>
                </div>
                <div className="flex border  flex-col w-full h-full py-2.5 px-6">
                    <div className="flex justify-between">
