...
const Budgets: FC = () => {
    ...
    const [filteredPayouts, setFilteredPayouts] = useState<Payout[]>(context?.payouts);
            ...
            <div className="pl-16 pr-5 mt-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 mt-8 gap-4">
                    {filteredPayouts.map((payout: Payout) => (
                        <Link
                            key={payout.id}
                            href={`/expenses/budgets/${payout.id}`}
                        >
                ...
                <div
                    className={`p-4 w-full mt-8 flex justify-evenly items-center ${filteredPayouts.length < 1 ? "" : "hidden"
                        }`}
                >
