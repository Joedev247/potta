  ...
  return (
    <Card className="bg-white shadow-sm hover:shadow-md transition-shadow duration-200">
      ...
      <CardContent>
        ...
        <div className="flex h-2 w-full overflow-hidden rounded-full bg-gray-200"> {/* Container/Track */}
           {/* Spent Segment (Orange) */}
           <div
             className="h-full bg-orange-400 transition-all duration-300 ease-in-out"
             style={{ width: `${spentPercent}%` }}
             title={`Spent: ${formatCurrency(spent, currency)} (${spentPercent.toFixed(1)}%)`} // Optional tooltip
           ></div>
           ...
           <div
             ...
             title={`Available: ${formatCurrency(available, currency)} (${availablePercent.toFixed(1)}%)`} // Optional tooltip
           ></div>
