...
const NewBudget: FC = () => {
    ...
    const HandleNewBudgetChange = (e: React.ChangeEvent<HTMLSelectElement | HTMLInputElement>) => {
    ...
    return (
        <Modal icon={<i className="ri-add-line"></i>} title="New Budget" text="Add New Budget">
                    ...
                    <div className="flex flex-col mt-6 px-8">
                        ...
                        <div className="w-full mb-3">
                            ...
                            <div className="flex w-full  rounded-md divide-x">
                                <div className="w-[90%]">
                                    <Input type={"number"} name={"budget_goal"} onchange={() => HandleNewBudgetChange}
                                        value={newBudget.budget_goal} />
                                </div>
                                <div className="mt-2">
                                    <Select options={[{ value: "XAF", label: "XAF" }]} border selectedValue={"XAF"} onChange={() => { }} bg={"border"} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="w-full mb-3">
                            ...
                            <Select options={[{ value: "One time", label: "One time" }]} border={false} selectedValue={"One time"} onChange={() => { }} bg={"border"} />
                        </div>
                    </div>
