...
const Left = () => {
    ...
    return (
        <div>
            <div className="w-full grid grid-cols-4 gap-4">
                ...
                <div className='-mt-2'>
                    <Input
                        type={'text'}
                        value={invoiceNumber}
                        onchange={(e: any) => handleInputChange('invoiceNumber', e.target.value)}
                    />
                </div>
            </div>
            ...
            <hr className="my-5" />
            <h3 className="text-xl font-thin my-2">Invoice Payment Methods</h3>
            <div className="mt-2">
            ...
            <div className="mt-5 w-full flex justify-end">
                <Button text={"Save Invoice"} onClick={handleSaveInvoice} type={'button'} />
            </div>
        </div>
    );
};
