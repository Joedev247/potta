...
// // Sample report data with proper typing
...
//       description: 'Overview of all disbursements',
...
//             {React.cloneElement(icon as React.ReactElement, { className: "h-6 w-6 mr-3 text-green-600" })}
...
//             <p className="font-medium">{categoryInfo?.label || 'Report'}</p>
//           </div>
...
//           {/* Placeholder for report content - this would be replaced with actual report data */}
...
//           <div>
//             <Button className="bg-white border border-gray-200 text-gray-700 mr-2">
//               <Printer className="h-4 w-4 mr-2" />
//               Print
//             </Button>
//             <Button className="bg-white border border-gray-200 text-gray-700">
