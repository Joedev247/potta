...
import {useDeleteVoucher} from "../_hooks/hooks";
...
const DeleteModal: React.FC<DeleteProps> = ({ voucherID,  open: controlledOpen,
...
// Local state as fallback if no controlled state is provided
  ...
  return (
    ...
    <Modal button={false} title="Delete Voucher" width="full" open={isOpen} setOpen={setIsOpen}>
      <div className="p-4">
