...
const SliderAgent = () => {
  const [selectedCategory, setSelectedCategory] = useState<Cat[] | null | any>(
    null
  );
  ...
  return (
    <Slider edit={false} title={'New Agent'} buttonText="agent">
      <div className="relative h-[97%] w-full">
        {/* here  */}
        <div className="mt-6">
          <p className="mb-3">Select Agent</p>
          <CustomSelect
            options={category}
        ...
        <div className="mt-6">
          <p className="mb-3">
            ...
            <small className="text-gray-400">
              <em>(you can only have one on each transction category)</em>
            </small>
          </p>
          <CustomSelect
            options={category}
        ...
        <div className="absolute bottom-0 right-0 m-5">
          <Button text={'Create Agent'} type={'button'} />
        </div>
      </div>
    </Slider>
  );
