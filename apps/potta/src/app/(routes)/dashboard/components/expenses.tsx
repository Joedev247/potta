            ...
            <div className="w-[50%] mt-2">
              <div className="grid grid-cols-1 md:grid-cols-1 justify-between gap-4 mt-5 pb-5 grow">
                <div className="flex flex-col  border grow">
                  <div className="flex border-b items-center p-4"><h1 className="text-[18px]">Total Expenses by person</h1></div>
                    ...
                    {datas.map((data, index) => (
                      <div key={index} className="flex w-full border-b py-2 justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <div className="ml-4">
                            <div className="font-thin text-gray-900">{data.firstname}</div>
                          </div>
                        </div>
                        <div className="ml-4 mt-2">
                          <div className="  text-gray-900 flex justify-end">CFA {data.accountBalance}</div>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="flex-1 flex-col w-full justify-between">
                  {
                    ExpensesData.map((items, index) => (
                      <div key={index} className="flex justify-between py-4 border-b w-full gap-2">
                        <div>{items.name}</div>
                        <div>{items.prix}</div>
                      </div>
                    ))
