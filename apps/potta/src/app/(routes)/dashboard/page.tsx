      ...
      <div className='pl-16 pr-5 mt-10'>
        <div className='w-full flex justify-between space-x-10'>
          <div className='w-[30%] flex'>
            <div onClick={() => setSwipe('collection')} className={`w-full h-12 flex justify-center cursor-pointer items-center bg-[#F3FBFB] ${swipe == 'collection' && 'border-b-2 border-[#154406] text-[#154406] font-medium'}`}>
              <p>Collections</p>
            </div>
            <div onClick={() => setSwipe('expenses')} className={`w-full h-12 flex justify-center cursor-pointer items-center bg-[#F3FBFB] ${swipe == 'expenses' && 'border-b-2 border-[#154406] text-[#154406] font-medium'}`}>
              <p>Expenses</p>
            </div>
          </div>
          <div className='w-[65%]  flex justify-end'>
            ...
            <div className='w-full h-12 flex border-r justify-center items-center bg-[#F3FBFB]'>
              <Select options={[{ label: "", value: "" }]} name='Pending' selectedValue={''} onChange={() => { }} bg={''} />
            </div>
            <div className='w-full h-12 border-r  flex justify-center items-center bg-[#F3FBFB]'>
              <Select options={[{ label: "", value: "" }]} name='MOMO' selectedValue={''} onChange={() => { }} bg={''} />
            </div>
