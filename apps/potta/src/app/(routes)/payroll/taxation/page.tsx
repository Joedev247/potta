    ...
    return (
        <RootLayout>
            <div className='md:w-[60%] w-full px-24 pt-10'>
                ...
                <div className='mt-8'>
                    <p>Enter your 11 digit alpha numeric Taxation ID, Down a sample of typical tax payers  card below for better reference. Or simply
                        request for a new ID and a correspondent from our team will reach out to you.</p>
                </div>
                <div className='mt-8'>
