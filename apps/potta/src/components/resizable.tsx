...
const ResizablePanelGroup = ({
  ...
  <ResizablePrimitive.PanelGroup
    className={cn(
      'flex h-full w-full data-[panel-group-direction=vertical]:flex-col space-x-2 ',
      className
    )}
    {...props}
  />
...
const ResizableHandle = ({
  ...
  >
    {withHandle && (
      <div className="z-10 flex h-4 w-3 items-center justify-center rounded-sm  bg-slate-200">
