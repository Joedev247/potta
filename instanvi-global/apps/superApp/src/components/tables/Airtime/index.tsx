...
const columns: TableColumn<DataRow>[] = [
    ...
    {
        name: <div className="w-full text-[17px] text-left pl-5">Discount</div>,
        cell: (row: any) => <div className="w-full text-[17px] text-left pl-5">{row.discount}</div>,
        sortable: true,
    },
    {
...
const AirtimeTable: FC<Props> = ({ data, records, setRecords }) => {
